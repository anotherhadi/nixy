{ pkgs, inputs, ... }:
{
  stylix = {
    ...
    base16Scheme = {
      ...
      base01 = "141617"; # Lighter Background (Used for status bars, line number and folding marks)
      ...
      base08 = "f26e74"; # Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
      ...
      base0D = "709ad2"; # Functions, Methods, Attribute IDs, Headings, Accent color
      base0E = "c58cec"; # Keywords, Storage, Selector, Markup Italic, Diff Changed
      base0F = "e8646a"; # Deprecated, Opening/Closing Embedded Language Tags, e.g. <?php ?>
    };
